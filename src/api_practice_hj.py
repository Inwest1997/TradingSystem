...
class api_call:
    ...
    # 아마 모의투자는 지원안하는듯
    #---------------------------------------------------------------
    def get_current_price(self ,ticker):			# 애플 코드 : AAPL / 테슬라 코드 : TSLA
        self.ticker =ticker
    ...
    # 아마 모의투자는 지원안하는듯
    #---------------------------------------------------------------
    def get_day_price(self, ticker):			# 애플 코드 : AAPL / 테슬라 코드 : TSLA
        self.ticker = ticker
    ...
    #---------------------------------------------------------------
    def get_order_buy(self, ticker , signal =0 ):			# 애플 코드 : AAPL / 테슬라 코드 : TSLA
        self.ticker = ticker
    ...
    def get_reserve_order(self):			# 애플 코드 : AAPL / 테슬라 코드 : TSLA
        ...
        URL = f"{URL_BASE}/{PATH}"
        headers = {"Content-Type":"application/json",
                    "authorization": f"Bearer {self.ACCESS_TOKENN}",
                    "appKey": APP_KEY,
                    "appSecret": APP_SECRET,
                    "tr_id":"VTTT3014U",
                    # 실전투자
    ...
    def get_inquire_ccn(self,date):
        ...
        "ORD_STRT_DT":date,           # 주문시작일자
        "ORD_END_DT": date,       # 주문종료일자
